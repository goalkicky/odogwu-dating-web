...
export default function MarketingFooter() {
  ...
  return (
    <footer style={{
      ...
      padding: isMobile ? '48px 20px 32px' : '80px 24px 40px',
    }}>
      <div style={{
        ...
        <div>
          ...
          <p style={{ color: '#6B6B6B', fontSize: 14, lineHeight: '22px', maxWidth: 280 }}>
            Find your perfect match with Odogwu Dating. Smart matching, verified profiles, real-time connections.
          </p>
        </div>

        {[
          { title: 'Company', links: [{ label: 'Features', href: '/features' }, { label: 'Plans', href: '/plans' }, { label: 'FAQ', href: '/faq' }] },
          ...
          <div key={section.title}>
            <h4 style={{
              fontSize: 14, fontWeight: 700, color: 'white', marginBottom: 16,
      ...
      <div style={{
        maxWidth: '1200px', margin: isMobile ? '40px auto 0' : '60px auto 0',
        paddingTop: 24, borderTop: '1px solid rgba(255,255,255,0.06)',
        display: 'flex', justifyContent: 'space-between', alignItems: 'center',
        flexWrap: 'wrap', gap: 16, flexDirection: isMobile ? 'column' : 'row',
