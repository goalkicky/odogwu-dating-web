...
export default function AnimatedCard({
  ...
  return (
    ...
    >
      <style jsx>{`
        .dc-photo { width: 100%; height: 575px; position: relative; background: #eee; overflow: hidden; }
        ...
        .dc-carve .dc-name h2 { font-size: 20px; letter-spacing: -0.5px; margin: 0; color: #111111; line-height: 1.15; font-weight: 700; }
        ...
        .dc-carve .dc-location { display: flex; align-items: center; gap: 5px; color: #5D616A; font-size: 13px; margin: 5px 0 0; flex-wrap: wrap; }
        ...
        .dc-location b { font-size: 15px; color: #858991; }
        .dc-bio { font-size: 11px; line-height: 1.45; margin: 0 0 25px; color: #111111; font-weight: 600; display: flex; align-items: flex-start; gap: 8px; }
        .dc-bio em { flex-shrink: 0; color: #E50046; font-size: 25pt; line-height: 1; font-weight: 800; font-style: normal; }
        .dc-int-h { font-size: 13px; margin: 0 0 8px; color: #111111; font-weight: 700; }
        ...
        .dc-facts { border-top: 1px solid #EBEBEE; display: grid; grid-template-columns: 1fr 1fr 1fr; padding: 12px 0 14px; }
        .dc-fact { position: relative; padding-left: 43px; min-height: 55px; }
        .dc-fact + .dc-fact { border-left: 1px solid #EBEBEE; padding-left: 55px; }
        .dc-fick { position: absolute; left: 8px; top: 4px; font-size: 24px; }
        .dc-fact + .dc-fact .dc-fick { left: 20px; }
        .dc-fact small { display: block; color: #858991; font-size: 14px; margin-bottom: 4px; }
        .dc-fact strong { display: block; font-size: 15px; font-weight: 500; color: #111111; white-space: nowrap; }
