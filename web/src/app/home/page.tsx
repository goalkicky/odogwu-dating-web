  ...
  return (
    <>
      <style jsx global>{`
        ...
        .tmpl-pink-btn { background: #D90540; color: #fff; border: 0; border-radius: 18px; width: 67px; height: 28px; padding: 2px; font-size: 14px; font-weight: 600; line-height: 17px; text-align: center; display: grid; place-items: center; cursor: pointer; white-space: nowrap; margin-left: 7.5px; flex-shrink: 0; box-sizing: border-box; }
