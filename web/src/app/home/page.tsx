    ...
    <>
      <style jsx global>{`
        ...
        @media (max-width: 560px) {
          ...
          .tmpl-stories { gap: 6px; display: grid; grid-template-columns: repeat(5, minmax(0, 1fr)); grid-auto-flow: column; }
          .tmpl-story-card { height: 240px; width: 100%; }
