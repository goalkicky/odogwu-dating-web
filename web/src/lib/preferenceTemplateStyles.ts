...
.dpr .bottom-actions button:disabled{opacity:.55}
...
@media(min-width:768px){
  .dpr .bottom-actions{left:calc(50% + 127px)}
}
@media(max-width:767px){
  .dpr{margin-left:-16px;margin-right:-16px}
  .dpr .bottom-actions{bottom:60px}
}
